...
The goal of vse4ts is to identify memory patterns in time series using variance scale exponent. It constructs variance scale exponent, achieving the identification of memory patterns in time series, especially long memory.
